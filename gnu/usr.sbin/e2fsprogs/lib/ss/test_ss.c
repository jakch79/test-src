 ...
 *------------------------------------------------------------------
 *
 * $Source: /usr/cvsync/src/gnu/usr.sbin/e2fsprogs/lib/ss/Attic/test_ss.c,v $
 * $Revision: 1.1 $
...
static char const rcsid_test_c[] =
    "$Header: /usr/cvsync/src/gnu/usr.sbin/e2fsprogs/lib/ss/Attic/test_ss.c,v 1.1 1997/06/14 07:18:45 downsj Exp $";
#endif /* lint */
