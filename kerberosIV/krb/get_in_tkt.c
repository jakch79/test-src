 ...
 *
 * $Source: /usr/cvsync/src/kerberosIV/krb/Attic/get_in_tkt.c,v $
 *
 * $Locker:  $
 */
...
"Bones$Header: /usr/cvsync/src/kerberosIV/krb/Attic/get_in_tkt.c,v 1.3 1997/01/17 07:11:54 millert Exp $";
#endif /* lint */
